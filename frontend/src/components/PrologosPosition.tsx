  ...
  return (
    <div className="prologos-row">
      ...
      <div className="car-brand-box">
        <img src={`${process.env.PUBLIC_URL}/brands/${carBrand.toLowerCase()}.png`} alt={carBrand} className="brand-logo" />
      </div>

      <div className="crew-box">
        <div className="pilot-info">
          <img src={`${process.env.PUBLIC_URL}/flags/${pilotCountry.toLowerCase()}.png`} alt={pilotCountry} className="flag-icon" />
          <span className="pilot-name">{pilotName}</span>
        </div>

        <div className="navigator-info">
          <img src={`${process.env.PUBLIC_URL}/flags/${navigatorCountry.toLowerCase()}.png`} alt={navigatorCountry} className="flag-icon" />
